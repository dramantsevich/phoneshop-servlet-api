...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private void saveSampleProducts() {
        ...
        productDao.create(new Product("sgs3", "Samsung Galaxy S III", new BigDecimal(300), usd,
        ...
        productDao.create(new Product("sgs", "Samsung Galaxy S", new BigDecimal(100), usd,
        ...
        productDao.create(new Product("sgs2", "Samsung Galaxy S II", new BigDecimal(200), usd,
        ...
        productDao.create(new Product("iphone", "Apple iPhone", new BigDecimal(200), usd,
        ...
        productDao.create(new Product("iphone6", "Apple iPhone 6", new BigDecimal(1000), usd,
        ...
        productDao.create(new Product("htces4g", "HTC EVO Shift 4G", new BigDecimal(320), usd,
        ...
        productDao.create(new Product("sec901", "Sony Ericsson C901", new BigDecimal(420), usd,
        ...
        productDao.create(new Product("xperiaxz", "Sony Xperia XZ", new BigDecimal(120), usd,
        ...
        productDao.create(new Product("nokia3310", "Nokia 3310", new BigDecimal(70), usd,
        ...
        productDao.create(new Product("palmp", "Palm Pixi", new BigDecimal(170), usd,
        ...
        productDao.create(new Product("simc56", "Siemens C56", new BigDecimal(70), usd,
        ...
        productDao.create(new Product("simc61", "Siemens C61", new BigDecimal(80), usd,
        ...
        productDao.create(new Product("simsxg75", "Siemens SXG75", new BigDecimal(150), usd,
